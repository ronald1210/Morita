...
<html>
    ...
    <body>
        <div class="container-fluid">
            <div class="container-fluid">
                <h1 class="text-center mb-3 mt-5">tortas Parecidas</h1>
                            ...
                            <c:forEach var="art" items="${ListaDet}">
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center"> 
                                        ...
                                        <div>
                                            <a href="detalleA.htm?ID_ART=${art.ID_ART}&ID_CAT=${art.ID_CAT}" class="btn btn-outline-info">
                            ...
                            <div class="carousel-item ">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center"> 
                                        <h5>S/. ${art.PRECIO_ART} </h5>
                                        <div>
                                            <a href="detallesA.htm?ID_ART=${art.ID_ART}&ID_CAT=${art.ID_CAT}" class="btn btn-outline-info">
                                                <i class="fa fa-info-circle"></i>  VER DETALLES
                                            </a>
                                        </div>
                                    </div>
